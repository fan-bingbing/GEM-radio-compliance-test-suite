...
RFile_write = load_workbook("C:\\Users\\afan\\Documents\\ACMA\\GX600D_VHF_maritime\\TestResult\\Tx_result.xlsx" ) # load Test_Result.xlsx
RSheet = RFile_write.create_sheet("Ferror_Pow")
...
RFile_write.save("C:\\Users\\afan\\Documents\\ACMA\\GX600D_VHF_maritime\\TestResult\\Tx_result.xlsx") # save existing .xlsx file
FSV.close()
