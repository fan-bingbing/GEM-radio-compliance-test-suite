...
sheet = File_write["Spurious_Response"] # load setup sheet in .xlsx to sheet
...
Spurious_Response = float(SMB.query(f":POW? "))+3.5-(15.5-3.5)
print(f"Spurious_Response result:{Spurious_Response}")
