...
AF_list = [2550, 3000, 4000, 5000, 6000, 8000, 12000, 12500]
...
# Level_AF = 100*Level_AF # no change of audio level for standard test condition
# SML.write(f":OUTP2:VOLT {Level_AF}mV")
for i in range(0,8):
    print(f"At Audio frequency:{AF_list[i]}Hz")
